...
public class PrimMinimumSpanningTree_mwj<V, E> implements Transformer<Graph<V, E>, Graph<V, E>>
{

    protected Factory<? extends Graph<V, E>> treeFactory;
    protected Transformer<E, Double> weights;
    protected V mSelectedRoot;

    /**
     * Creates an instance which generates a minimum spanning tree assuming
     * constant edge weights.
     */
    public PrimMinimumSpanningTree_mwj(Factory<? extends Graph<V, E>> factory)
    {
    ...
    {
        //Use the selected node if it is available
        if (mSelectedRoot != null)
        {
            return (mSelectedRoot);
        }
