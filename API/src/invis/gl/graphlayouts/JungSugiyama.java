...
/**
 * Arranges the nodes with the Sugiyama Layout Algorithm.<br> * <a
 * href="http://plg.uwaterloo.ca/~itbowman/CS746G/Notes/Sugiyama1981_MVU/"> Link
...
public class JungSugiyama<V, E> extends AbstractLayout<V, E>
{
    ...
    protected V mSelectedRoot; //a hack to force the selection of my desired root.
     ...
     * the LinkedList per level contains Cell Wrapper Objects. After that the
    ...
    public void setSelectedRoot(V v)
    {
        mSelectedRoot = v;
    }
    ...
    private LinkedList<V> searchRoots(Set<V> vertexSet)
    {
        ...
        if (mSelectedRoot != null)
        {
            roots.add(mSelectedRoot);
        } else
        {
     ...
     * These LinkedLists are the elements in the
     ...
     * @param currentLevel LinkedList which contains the CellWrappers for the
     * current level
