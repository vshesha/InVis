...
public class MinimumSpanningForest2_mwj<V, E>
{
     ...
     * @param weights
     */
    public MinimumSpanningForest2_mwj(Graph<V, E> graph,
            ...
            V root)
    {
        ...
        {
            PrimMinimumSpanningTree_mwj<V, E> mst =
                    new PrimMinimumSpanningTree_mwj<V, E>(treeFactory, this.weights);
            mst.setSelectedRoot(mSelectedRoot);
