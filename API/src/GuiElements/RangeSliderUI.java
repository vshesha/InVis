...
class RangeSliderUI extends BasicSliderUI
{
     ...
     */
    private Color rangeColor = new Color(201, 131, 96);//Color.GREEN;
    /**
    ...
    private void paintLowerThumb(Graphics g)
    {
        ...
        g2d.setColor(new Color(229, 202, 127));
        g2d.fill(thumbShape);

        g2d.setColor(new Color(219, 169, 108));
        g2d.draw(thumbShape);
    ...
    private void paintUpperThumb(Graphics g)
    {
        ...
        g2d.setColor(new Color(166, 88, 81));
        g2d.fill(thumbShape);

        g2d.setColor(new Color(84, 40, 60));
        g2d.draw(thumbShape);
