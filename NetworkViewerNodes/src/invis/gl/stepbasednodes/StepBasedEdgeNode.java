 ...
 * @author Matt
 */
public class StepBasedEdgeNode extends AbstractNode implements PropertyChangeListener
{

    private NetworkClusterElementApi mNCVA;

    public StepBasedEdgeNode(Children children, NetworkClusterElementApi data)
    {
        super(children, Lookups.singleton(data));
        this.setModel(data);
        this.setDisplayName(data.getValue() + " Actions: " + data.getNetworkElementSet().size() + " Freq: " + data.getTotalUniqueFrequency());
        this.AddModelListeners();
    }

    public NetworkClusterElementApi getData()
    {
        return (mNCVA);
    }
    ...
    private void setModel(NetworkClusterElementApi data)
    {
        this.mNCVA = data;
    }
    ...
    public void propertyChange(PropertyChangeEvent evt)
    {
        ...
        {
            if (((NetworkClusterElementApi) evt.getSource()).getSelected())
            {
